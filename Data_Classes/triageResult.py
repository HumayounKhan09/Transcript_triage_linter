...
class triageResult:
    def __init__(self, intent: str, escalate: bool, risk_level: str, reason_codes: list[reasonCode], entities: list[Entities], summary_bullet: list[str]):
        self._intent = intent
    ...
    def __str__(self) -> str:
        return f"triageResult(intent={self._intent}, escalate={self._escalate}, risk_level={self._risk_level}, reason_codes={self._reason_codes}, entities={self.entities}, summary_bullet={self._summary_bullet})"
